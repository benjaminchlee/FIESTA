...
public class InteractionsManager : MonoBehaviour
{
    ...
    private void Start()
    {
        Invoke("GetControllersAndScripts", 0.05f);
    }
    ...
    private void GetControllersAndScripts()
    {
        ...
        if (leftController != null && rightController != null)
        {
            ...
            {
                rangedInteractionsScript = leftController.GetComponentInChildren<RangedInteractions>() != null ? leftController.GetComponentInChildren<RangedInteractions>() : rightController.GetComponentInChildren<RangedInteractions>();
    ...
    private void SetInteractionState(InteractionState state)
    {
        switch (state)
        {
            // WRONG // If there are no active interactions, let the update loop check for the ones which are enabled
